...
/**
 * @typedef {Object} ParserCommand
 * @property {string[] | string} signature
 * @property {string?} method
 * @property {boolean?} notimpl
...
/** 
 * @typedef {Object} VarRefBase
 * @property {any[]} ref
 * @property {number} idx
 */

/** @typedef {VarRefBase | string} VarRef*/

/**
 * @typedef {Object} ForStackItem
...
class Parser {
	...
	/** 
	 * @param {boolean?} dojoin
	 * @param {string} sep
	*/
	getMatrix(dojoin, sep) {
		this.rule = 'getMatrix';
	 ...
	 * @param {string?} sep 
	 */
	commandArguments(signature, isfunc, sep) {
	...
	getValue() {
		...
		else if (this.ttk == 'integer' || this.ttk == 'float' || this.ttk == 'inthexa' || this.ttk == 'intbin') {
			if (this.ttk == 'inthexa') {
				value = this.tval.replace(/^\&H/i, '');
				value = parseInt(value, 16);
			}
			else if (this.ttk == 'intbin') {
		...
		else if (Parser.functions[this.ttk]) {
